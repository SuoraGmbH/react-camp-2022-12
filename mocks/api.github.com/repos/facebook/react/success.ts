...
export const githubRepoFacebookReactSuccessMock = rest.get(
  ...
  (req, res, { json }) => {
    return res(
      json({
        ...
        updated_at: "2022-12-13T09:49:51Z",
        pushed_at: "2022-12-13T06:33:02Z",
        ...
        size: 211761,
        stargazers_count: 199045,
        watchers_count: 199046,
        language: "JavaScript",
        has_issues: true,
        has_projects: true,
        has_downloads: true,
